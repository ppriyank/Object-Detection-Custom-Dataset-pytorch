...
# def true_box(images, boxes, labels, difficulties,name=""):
...
# 	# original_dims = torch.FloatTensor([4032, 3024, 4032, 3024]).unsqueeze(0)
...
#     # Annotate
# 	images_array = images.to('cpu').permute(1,2,0).numpy()
...
# 	              font=font)
# 	annotated_image.save(name + "_temp.jpg", "JPEG")


# images, boxes, labels, difficulties = next(iter(train_dataset))
# true_box(images, boxes, labels, difficulties)
